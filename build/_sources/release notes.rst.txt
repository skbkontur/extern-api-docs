...
* Поддержали :doc:`работу</scenarios/FSS/proactive_ algorithm>` с новыми документооборотами СЭДО:
...
* Поддержали работу с :doc:`машиночитаемой доверенностью в ФСС</scenarios/FSS/mchd_fss>`. Алгоритм работы в API смотрите в :doc:`статье</scenarios/FSS/proactive_ algorithm>`. 
...
* В методах API добавлена возможность формирования подписи xmlDsig для подписания :doc:`отчета СЗВ-ТД и заявления на подключение к ЭДОК в ПФР</PFR/szvtd>`. Подробное описание в документации: :doc:`Подпись XMLDsig для отчетов в ПФР</manuals/xmldsig>`.
