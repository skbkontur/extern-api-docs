...
Чтобы убедиться, какой именно документ нужно сформировать в ответ (КоП или УО), нужно :ref:`проверить требование<rst-markup-fns-check-demand>`. Если по окончании работы метода :ref:`POST Check-Demand<rst-markup-check-demand>` были выявлены ошибки, то можно переходить к формированию УО. Ссылка на генерацию документа и коды ошибок будут перечислены в ответе метода. Если ошибки при проверке требования не найдены, можно формировать КоП. 
...
.. note:: Только для требований с КНД 1165050, 1165013, 1152006, 1153007 и 1125008. 
...
Сообщение об исчисленной налоговым органом сумме транспортного налога ЮЛ КНД 1152006
    *На сообщение нужно отправить опись со списком запрашиваемых документов*.

Сообщение об исчисленной налоговым органом сумме земельного налога ЮЛ КНД 1153007
    *На сообщение нужно отправить опись со списком запрашиваемых документов*. 

Запрос о представлении документов и информации в орган валютного контроля КНД 1125008
    *На запрос нужно отправить опись со списком запрашиваемых документов*. 
