...
-  :download:`пример JSON для формирования файла декларации УСН при подаче<../files/usn/USN1 for self.txt>`;
...
-  :download:`пример JSON для формирования файла декларации УСН при подаче<../files/usn/USN2 for self.txt>`;

    -  используется при ;


JSON для ИОН запросов
---------------------
