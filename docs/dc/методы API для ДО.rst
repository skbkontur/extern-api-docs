...
* Получать список документооборотов с использованием фильтра type. За один запрос рекомендуем получать только один тип. Все типы документооборотов указаны в :doc:`/specification/статусы ДО<спецификации>`.
...
Для документооборотов типа urn:docflow:fns534-inventory нужно использовать методы из раздела :doc:`/inventories/index<Представление документов к требованиям>`.
