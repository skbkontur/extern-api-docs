...
* 400 — расшифрованный контент некоторых документов не был найден в запросе и не был предварительно загружен. Если дешифрование было выполнено с помощью DSS сертификата, убедитесь, что для данного абонента включена настройка, разрешающая хранить расшифрованные контенты.
