...
* `Проверка документооборота требования`_
...
- Если ошибки были выявлены, они будут перечислены в поле error-codes, можно передать их при формировании уведомления об отказе.
...
+==========================================+============+===================================+
| Проверка файла |br|                      | 0300300001 | Файл не соответствует |br|        |
| требования ON_DOCNPNO*.xml |br|          |            | xsd-схеме                         |
| на соответствие xsd-схеме |br|           |            |                                   |
+------------------------------------------+------------+-----------------------------------+
| Сравниваются ИНН-КПП из |br|             | 0400100005 | ИНН/КПП налогоплательщика |br|    |  
| ON_DOCNPNO*.xml с  |br|                  |            | не соответствует ИНН/КПП |br|     |
| организациями клиента.                   |            | в отправленном транспортном |br|  |
|                                          |            | контейнере                        |
+------------------------------------------+------------+-----------------------------------+
| Сравниваются количество  |br|            | 0300300030 | Нарушено условие присутствия |br| |
...
+------------------------------------------+------------+-----------------------------------+
| Для всех документов проверяется  |br|    | 0100100004 | ЭП не соответствует  |br|         |
| соответствие подписи контенту            |            | подписанному документу  |br|      | 
|                                          |            | (ЭП искажена или в документ  |br| |
|                                          |            | были внесены изменения уже  |br|  |
