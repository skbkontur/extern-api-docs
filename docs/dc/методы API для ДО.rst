...
См. раздел :doc:`Облачная криптография → Методы для работы в документооборотах </cloud/методы в ДО>`, методы "Дешифрование документа" и "Подтверждение дешифрования документа".
