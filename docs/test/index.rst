...
* для МВД в параметре ``mvd-code``:
    ...
    * 770-001 — возвращает недетализированный отказ несколько раз подряд.
    * 020-017 — возвращает неизвестный результат.
    * 020-016 — возвращает ответ от API Госуслуг. Зависит от переданных данных.