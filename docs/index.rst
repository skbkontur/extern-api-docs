...
.. _`API Экстерна для работсы со сверкой по НДС`: https://developer.kontur.ru/doc/extern.nds
...
2. Создать черновик отчета и подготовить его к отправке в контролирующие органы, такие как ФНС, ФСС, ПФР, Росстат.
...
* Документация Swagger:
  ...
  *  `API Экстерна для работы со сверкой по НДС`_.
