.. _`API учетных записей, черновиков и сервиса контентов`: https://developer.kontur.ru/doc/extern
.. _`API документооборотов`: https://developer.kontur.ru/doc/extern.docflows
...
* Документация Swagger:
   ...
   * `API учетных записей, черновиков и сервиса контентов`_
   * `API документооборотов`_
