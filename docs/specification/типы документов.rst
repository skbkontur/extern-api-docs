...
.. csv-table::
   ...
   :widths: 20 80
      ...
      "urn:document:mvd-notification-epgu-protocol", "Результат обработки уведомления:"
         * Положительный результат: уведомление принято в МВД
         * Отрицательный результат: уведомление не принято в МВД
            * Детализированный отказ: уведомление не принято в МВД. Содержит причину отказа
            * Недетализированный отказ: уведомление не принято в МВД. Не содержит причину отказа
