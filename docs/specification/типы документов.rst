...
Подписка оператора на документооборот с СФР по абоненту
+++++++++++++++++++++++++++++++++++++++++++++++++++++++
...
Запрос недостающих сведений для назначения пособия СФР
++++++++++++++++++++++++++++++++++++++++++++++++++++++
...
.. csv-table::
   ...
   :widths: 60 60
      ...
      "urn:document:fss-sedo-benefit-payment-initiation-result-document", "Сообщение «Результат обработки сообщения инициации выплат СФР"
...
Запрос регистрации или отзыва доверенности СФР
++++++++++++++++++++++++++++++++++++++++++++++++
...
.. csv-table::
   ...
   :widths: 60 60
      ...
      "urn:document:fss-warrant-management-request-message", "SOAP-сообщение на отправку создания или отзыва доверенности СФР"
      "urn:document:fss-warrant-management-request-document", "Исходный документ создания или отзыва доверенности СФР до формирования SOAP-сообщения"
      ...
      "urn:document:fss-warrant-management-response-message", "Результат обработки создания или отзыва доверенности СФР"
...
.. csv-table::
   ...
   :widths: 60 60
      ...
      "urn:document:sedo-message-responce", "Исходный документ ответа на запрос, содержит документ с требованием СФР"
      "urn:document:fss-sedo-demand-demand-message", "Документ с требованием СФР"
...
.. csv-table::
   ...
   :widths: 60 60
      ...
      "urn:document:fss-sedo-demand-reply-request", "Запрос на отправку ответа на требование СФР"
      "urn:document:fss-sedo-demand-reply-reception-result", "Результат приема запроса порталом"
      "urn:document:fss-sedo-demand-reply-result-document", "Результат обработки ответа на требование СФР"
...
Запрос на формирование справки о расчетах СФР
+++++++++++++++++++++++++++++++++++++++++++++
...
.. csv-table::
   ...
   :widths: 60 60
      ...
      "urn:document:fss-sedo-billing-information-demand-result-document", "Результат обработки запроса справки о расчетах СФР"
      "urn:document:fss-sedo-billing-information-demand-billing-information-message", "Справка о расчетах СФР"
...
.. csv-table::
   ...
   :widths: 60 60
      ...
      "urn:document:sedo-message-responce", "Исходный документ ответа на запрос, содержит документ со справкой о расчетах СФР"
      "urn:document:fss-sedo-billing-information-billing-information-message", "Справка о расчетах СФР"
...
.. csv-table::
   ...
   :widths: 60 60
      ...
      "urn:document:fss-sedo-proactive-process-events-notification-read-receipt", "Отметка о прочтении"
...
Тип документооборота: urn:docflow:fss-sedo-proactive-salary-notification

.. csv-table::
   :header: "Urn", "Комментарий (согласно нормативным документам)"
   :widths: 60 60

      "urn:document:fss-sedo-proactive-salary-notification-request-message", "Запрос на получение документов"
      "urn:document:fss-sedo-proactive-salary-notification-document", "Документ сведений, необходимых для исчисления страхователем первых 3 дней пособия по временной нетрудоспособности"
      "urn:document:fss-sedo-proactive-salary-notification-abonent-read-receipt", "Отметка о прочтении"
      "urn:document:fss-sedo-proactive-salary-notification-exchange-error", "Ошибка взаимодействия с СЭДО"

Запрос информации о судебном ограничении
+++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++

Тип документооборота: urn:docflow:fss-sedo-judicial-restriction
...
.. csv-table::
   ...
   :widths: 60 60
      ...
      "urn:document:fss-sedo-payment-details-demand-request-message", "Запрос на получение документов"
      "urn:document:fss-sedo-payment-details-demand-document", "Документ запроса информации о судебном ограничении"
      "urn:document:fss-sedo-judicial-restriction-abonent-read-receipt", "Отметка о прочтении"
      "urn:document:fss-sedo-payment-details-demand-exchange-error", "Ошибка взаимодействия с СЭДО"

Ответ на запрос информации о судебном ограничении
++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++

Тип документооборота: urn:docflow:fss-sedo-judicial-restriction-reply

.. csv-table::
   :header: "Urn", "Комментарий (согласно нормативным документам)"
   :widths: 60 60

      "urn:document:fss-sedo-judicial-restriction-reply-request", "Запрос на отправку ответа на запрос информации о судебном ограничении"
      "urn:document:fss-sedo-judicial-restriction-reply-reception-result", "Результат отправки сообщения на портал"
      "urn:document:fss-sedo-judicial-restriction-reply-result-document", "Результат ответа на запрос информации о судебном ограничении"
      "urn:document:fss-sedo-judicial-restriction-reply-exchange-error", "Ошибка взаимодействия с СЭДО"
      "urn:document:fss-sedo-judicial-restriction-reply-error-message", "Ошибка обработки"
