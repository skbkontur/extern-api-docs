...
.. csv-table:: 
   ...
   "urn:document:sfr-report-protocol-check", "Протокол проверки", "УППО"
   "urn:document:sfr-report-protocol-refinement-notice", "Уведомление об устранении ошибок и (или) несоответствий", "УУОН-ПУ"
   ...
   "urn:document:sfr-report-protocol-refinement-notice-receipt", "Уведомление о доставке. Отправляется в ответ на уведомление об устранении ошибок и (или) несоответствий и протокола проверки", "УОД"
...
.. csv-table::
   ...
   :widths: 20 80
      ...
      "urn:document:sedo-message-responce", "Исходный документ ответа на запрос, содержит документ с результатом обработки запроса"
...
.. csv-table::
   ...
   :widths: 20 80
      ...
      "urn:document:sedo-message-responce", "Исходный документ ответа на запрос, содержит документ с результатом регистрации сведений"
...
Результат инциации выплат пособия
+++++++++++++++++++++++++++++++++
...
.. csv-table::
   ...
   :widths: 20 80
      ...
      "urn:document:fss-sedo-benefit-payment-initiation-result-request-message", "Запрос на получение «Результата обработки сообщения инициации выплат ФСС»"
      "urn:document:sedo-message-responce", "Исходный документ ответа на запрос, содержит документ с резульатом обработки сообщения инициации выплат ФСС"
      "urn:document:fss-sedo-benefit-payment-initiation-result-status-document", "Сообщение «Результат обработки сообщения инициации выплат ФСС»"
      "urn:document:fss-sedo-benefit-payment-initiation-result-error-message", "Ошибка обработки"
      "urn:document:fss-sedo-benefit-payment-initiation-result-exchange-error", "Ошибка взаимодействия с порталом СЭДО"
...
.. csv-table::
   ...
   :widths: 20 80
      ...
      "urn:document:sedo-message-responce", "Исходный документ ответа на запрос, содержит документ с уведомлением о статусе выплаты пособия"
...
.. csv-table::
   ...
   :widths: 20 80
      ...
      "urn:document:fss-warrant-management-result-request-message", "Запрос на получение результата создания или отзыва доверенности ФСС"
      "urn:document:sedo-message-responce", "Исходный документ ответа на запрос, содержит документ с результатом обработки создания или отзыва доверенности ФСС"
      "urn:document:fss-warrant-management-result-status-document", "Результат обработки создания или отзыва доверенности ФСС"
      "urn:document:fss-warrant-management-result-error-message", "Ошибка в ходе данного документооборота"
      "urn:document:fss-warrant-management-result-exchange-error", "Ошибка взаимодействия с СЭДО"
...
.. csv-table::
   ...
   :widths: 20 80
      ...
      "urn:document:fss-sedo-receipt-notification-result-request-message", "Запрос на получение результата подтверждения прочтения"
      "urn:document:sedo-message-responce", "Исходный документ ответа на запрос, содержит документ с результатом подтверждения прочтения"
      "urn:document:fss-sedo-receipt-notification-result-status-document", "Результат подтверждения прочтения"
      "urn:document:fss-sedo-receipt-notification-result-exchange-error", "Ошибка взаимодействия с порталом СЭДО"
...
.. csv-table::
   ...
   :widths: 20 80
      ...
      "urn:document:fss-sedo-demand-message", "Документ с требованием ФСС"
...
.. csv-table::
   ...
   :widths: 20 80
      ...
      "urn:document:fss-sedo-demand-reply-result-request-message", "Запрос на получение результата обработки ответа на требование ФСС"
      "urn:document:sedo-message-responce", "Исходный документ ответа на запрос, содержит документ с результатом обработки ответа на требование ФСС"
      "urn:document:fss-sedo-demand-reply-result-status-document", "Результат обработки ответа на требование ФСС"
      "urn:document:fss-sedo-demand-reply-result-exchange-error", "Ошибка взаимодействия с порталом СЭДО"
...
.. csv-table::
   ...
   :widths: 20 80
      ...
      "urn:document:fss-sedo-billing-information-demand-result-request-message", "Запрос на получение документов"
      "urn:document:sedo-message-responce", "Исходный документ ответа на запрос, содержит документ с результатом обработки запроса справки о расчетах ФСС"
      "urn:document:fss-sedo-billing-information-demand-result-status-document", "Результат обработки запроса справки о расчетах ФСС"
      "urn:document:fss-sedo-billing-information-demand-result-exchange-error", "Ошибка взаимодействия с порталом СЭДО"
