...
Запрос на регистрацию или отзыв доверенности СФР
~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
...
.. csv-table::
   ...
   "urn:transaction:fss-warrant-management-request", "Запрос на регистрацию или отзыв доверенности"
   "urn:transaction:fss-warrant-management-response", "Подтверждение от СЭДО о получении запроса"
   "urn:transaction:fss-warrant-management-error", "Ошибка в ходе документооборота"
   "urn:transaction:fss-warrant-management-result-positive", "Запрос принят"
   "urn:transaction:fss-warrant-management-result-negative", "Запрос отклонен"
   "urn:transaction:fss-warrant-management-abonent-read-receipt", "Отметка о прочтении"