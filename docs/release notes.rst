...
* Поддержали в методе :ref:`Получение списка документоборотов<rst-markup-get-dcs>` поиск документооборотов описи urn:docflow:fns534-inventory через фильтр ``type``.
