      ...
      .. tab:: тип business-registration
         ...
         * ``registration-info`` — сведения для регистрации бизнеса:
            ...
            * ``ip-info`` — информация об ИП;
               * ogrn-ip: не используется для заявления типа Р21001
   ...
   * ``builder-data`` — данные для указанного типа DraftsBuilder. Состав полей будет отличаться для каждого типа DraftsBuilder. 
      ...
      .. tabs::
         ...
         .. tab:: тип pfr-report
            ...
            Для DraftsBuilder типа pfr-report параметр builder-data не передается или указывается со значением null. 
...
* ``builder-data`` — данные для указанного типа DraftsBuilder. Состав полей будет отличаться для каждого типа DraftsBuilder.
   ...
   .. tabs::
      ...
      .. tab:: тип fns534-inventory
         ...
         **Пример метаинформации для создания файла**:
      ...
      .. tab:: тип pfr-report
         ...
         **Пример метаинформации для создания файла**:
         ...
         .. code-block::
            ...
            {
               "FileName": "AnyFileName.pdf",
               "builder-type": "urn:drafts-builder:pfr-report",
               "BuilderData": null
            }
