...
Подписки СЭДО ФСС на получение входящих документооборотов
=========================================================

Для получения входящих документооборотов от ФСС в рамках СЭДО необходимо выполнить **подписку оператора на организацию по РНС** (тип документооборота urn:docflow:fss-sedo-provider-subscription).
