...
Когда вы получите api-key и заключите договор, вам будут высланы данные вашей учетной записи. Также в момент подключения мы создадим для вас тестовую учетную запись, сертификат и организацию, чтобы вы могли отправлять запросы и познакомиться с API. 
