...
:download:`пример файла Уведомление о ввозе <../files/rnpt/ON_UVOSTTOV_0088_0089_6676130154667601001_20210727_e8f5886e_494e.xml>`

Создание и отправка черновика Уведомления о ввозе
~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
...
Чтобы завершить работу с документоооборотом уведомления о ввозе нужно:
...
2. На квитанцию о приеме (или уведомление об отказе) необходимо отправить ответный документ — Извещение о получении. Для этого:
    ...
    2. Подписать квитанцию о приеме при помощи сертификата, установленного на компьютере пользователя. Либо при помощи DSS сертификата методами `POST SignReplyDocument`_ и `POST SignConfirmReplyDocument`_.
