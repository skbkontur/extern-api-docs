...
На текущий момент через данный сервис возможно работать с документооборотами, которые участвуют в схеме :ref:`Проактивных выплат<rst-markup-proactiv>`. К ним также относятся следующие документообороты:
