...
Файл подписи нужно прикладывать для всех формализованных файлов. Для некоторых документооборотов, например, при ответе на требование о предоставление пояснений, нужно прикладывать счета-фактуры и накладные. Счет-фактура состоит из **xml**-файла и **sgn**-файла подписи контрагента. При работе с DraftsBuilder необходимо прикладывать оба файла. 


 .. image:: /_static/DB_sf.png
     :width: 900px

Также при ответе на требование о предоставлении пояснений можно приложить и другие формализованные документы, которые состоят только из **xml**-файлов. В таком случае, нужно дополнительно приложить **sgn**-файл подписи контрагента. Если подписи контаргента нет, то необходимо приложить файл подписи отправителя.
