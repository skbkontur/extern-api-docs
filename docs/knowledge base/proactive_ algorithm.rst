...
4. Возьмите идентификатор контента для подписания из метаинформации ответа метода ``AddDocument`` в поле ``data-to-sign-content-id`` и получите данные через :ref:`Сервис контентов<rst-markup-dowload>`. 
...
1. Документы появятся в текущих и исходящих ДО в следующих документооборотах:
