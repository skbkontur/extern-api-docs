...
О том, как обмениваться с ФСС исходящими и входящими документооборотами смотрите статью :doc:`Алгоритм работы с методами в проактивных выплатах</knowledge base/proactive_ algorithm>`.
