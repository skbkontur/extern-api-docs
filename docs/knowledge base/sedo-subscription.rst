...
.. important:: **Для тестирования отправки подписок** есть специальный робот, который эмулирует работу приемного комплекса на тестовой площадке. Для этого  нужно в п.2 при создании документа указать **FssCode: SEDO-TEST**.
