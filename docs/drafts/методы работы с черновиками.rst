...
Метод создает общий черновик в веб-интерфейсе Контур.Экстерна и передает метаинформацию черновика из API. В ответе будет возвращена ссылка на созданный черновик в веб-интерфейсе.
