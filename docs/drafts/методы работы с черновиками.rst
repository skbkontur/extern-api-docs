...
С помощью данного метода можно получить список черновиков для указанной учетной записи. Метод вернет 100 черновиков за один запрос. Список можно отфильтровать по заданным параметрам. 
