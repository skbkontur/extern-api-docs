...
Данный раздел посвящен методам, с помощью которых можно работать с документами в черновике. С методами для работы с черновиком в целом, в том числе и его создание, можно ознакомиться в разделе :doc:`Методы для работы с черновиками </drafts/методы работы с черновиками.rst>`  
