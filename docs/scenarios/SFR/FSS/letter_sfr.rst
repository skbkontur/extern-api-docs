...
Ответ страхователя на обращение СФР является отдельным документооборотом urn:docflow:fss-sedo-appeal-reply. Статусы и порядок взаимодействия описаны в :ref:`спецификации<rst-markup-fss-sedo-appeal-reply>`.

Алгоритм работы с методами для создания и отправки ответа на требование смотрите в статье :doc:`Работа с исходящими документооборотами</scenarios/SFR/FSS/proactive_isch>`.
