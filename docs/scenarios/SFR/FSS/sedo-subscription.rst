...
Для получения входящих документооборотов от СФР в рамках СЭДО нужно выполнить **подписку оператора на организацию по РНС** (тип документооборота urn:docflow:fss-sedo-provider-subscription).
