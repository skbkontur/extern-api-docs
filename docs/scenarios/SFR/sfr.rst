...
.. note:: Прежде, чем отправлять формы в СФР, нужно направить :doc:`заявление на подключение к электронному документообороту с контролирующим органом</scenarios/SFR/zped>`.
