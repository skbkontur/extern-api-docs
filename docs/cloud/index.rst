...
.. note:: 1. Подписать некоторые технологические документы в ходе документооборота можно без ввода кода из смс-сообщения. Для этого в отдельных методах для работы с документооборотами есть специальный параметр :ref:`→ <rst-markup-post-sign-reply-doc>`.
