...
* в ответе возвращается идентификатор запроса и отправляется смс-сообщение с кодом (на тестовом стенде для получения кода необходимо воспользоваться telegram-ботом @cloud_crypt_sms_bot),
